...
#plot creates the hex grid and points creates the points on top of the hex grid
plot(hexes)
...
# remove species with NA for SppCode (species code) (birds, crocodiles)
...
#This line says to loop through each of the three camera operation data set, the i=1,2,3, corresponding to the dataset
...
# when you write "dplr::" you are telliing it what package (in this case, dplyr)to use the function from. Useful if different R packages have functions with the same names
...
#ncol = number of columns, tells you have many columns in a data frame
  RAI.table <- RAI.table %>% gather(3:ncol(RAI.table), key = "CommName", value = "Count")
# This line basically says take all the columns from column 3 onward and reshape them into two new columns called CommName and Count.”
...
# RAI = Number of detections / Number of camera trap operation days
